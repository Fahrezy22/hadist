<script src="{{asset('static/admin/vendors/js/vendor.bundle.base.js')}}"></script>
...
<script src="{{asset('static/admin/js/dataTables.select.min.js')}}"></script>
...
<script src="{{asset('static/admin/js/settings.js')}}"></script>
<script src="{{asset('static/admin/js/todolist.js')}}"></script>
